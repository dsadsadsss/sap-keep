// 环境变量配置(必填)
let email = "1";      // SAP登录邮箱,直接填写或设置环境变量，变量名：EMAIL
let password = "1";   // SAP登录密码,直接填写或设置环境变量，变量名：PASSWORD
...
const MONITORED_APPS = [ // 格式: {url: "应用URL", name: "应用名称"}
  {url: "https:/.", name: ""}, 
  {url: "https://demand.com", name: ""}, 
  {url: "https:/ndemand.com", name: ""}, 
  {url: "https://hand.com", name: ""},
  {url: "https://pa.ondemand.com", name: ""}, 
  {url: "https://1.hana.ondemand.com", name: ""},  
  {url: "https://0nd.com", name: ""}
];
...
function generateStatusPage(apps) {
  ...
  const statusCards = apps.map(app => {
    ...
    const maskedName = maskAppName(app.app);
